...
class ModelDownloader:
    ...
    async def download_default_model(self, model_type: str, model_name: str) -> Optional[Path]:
        """
        ...
        if not repo_id:
            logger.warning(f"No default repository configured for {model_type} model '{model_name}'")
            return None
